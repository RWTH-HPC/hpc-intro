...
# This snippet can provide specific information on how the apptainer executable is
# available on the platform used.
snippets('container/apptainer-info.Rmd')
```
...
```{r, echo=FALSE, results='asis'}
# This snippet can provide additional information on the location of container images
# in the HPC system filesystem. Add additional info you want your users to considerations
# here.
snippets('container/container-location-info.Rmd')
```
